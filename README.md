...
{
    "require": {
        "xiaohuasheng0x1/erc-php-co": "^1.0.0"
    }
}
```
...
> 或者直接 `composer require xiaohuasheng0x1/erc-php-co:^1.0.0`
...
初始化你可以直接给一个RPC的连接地址，或者参考`Swlib\Saber Options`给出一些自定义的选项。

```php
use Ethereum\Client as EthereumClient;
